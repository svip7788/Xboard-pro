...
window.XBOARD_TRANSLATIONS['en-US'] = {
  ...
  "settings": {
    ...
    "subscribe": {
      ...
      "subscribe_refresh_lock_enable": {
        "title": "Subscribe Refresh Lock",
        "description": "When enabled, users must click \"Unlock Subscribe\" in their dashboard before fetching the subscription. The unlock window auto-expires."
      },
      "subscribe_refresh_lock_duration_minutes": {
        "title": "Unlock Window Duration (minutes)",
        "description": "How long the subscribe-refresh window stays open after a user clicks unlock. Range 1-1440, default 10."
      },
